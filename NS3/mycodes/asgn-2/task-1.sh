...
gnuFile1="scratch/asgn-2/cwnd.plt"
gnuFile2="scratch/asgn-2/thrput.plt"
gnuFile3="scratch/asgn-2/fairnessIndex.plt"

rm -rf scratch/asgn-2/results || rmdir scratch/asgn-2/results
...
mkdir -p "scratch/asgn-2/results/$plottitle2"
path="scratch/asgn-2/results/$plottitle2"
bttlnkRates=("1" "5" "10" "20" "50" "100" "200" "300")

# vary bttlnkRate 
for i in "${bttlnkRates[@]}"; do
    ./ns3 run "scratch/asgn-2/task-1.cc --tcp2=$tcp --bttlnkRate=$i --results=$path --experimentNo=1"
...
# vary pcktLossExp
for i in {2..6}; do
    ./ns3 run "scratch/asgn-2/task-1.cc --tcp2=$tcp --pcktLossExp=$i --results=$path --experimentNo=2"
